...
I also implemented a library which detects if a user is on a mobile device, and then used that to hide the 3d graphic for mobile users. (since mobile users can't really click and drag with a mouse)

## Additions

To go along with the 3D directory / home page revamp / whatever you want to call it, I added some text to 
