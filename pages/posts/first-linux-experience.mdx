...
## Ricing
One of the other things I wanted to quickly mention in this post was my experience with ricing my system. XFCE is super easy to customize and it took me probably an hour to customize my system. If you're curious, here are my specs:
- DE: Xfce 4.18 
- WM: Xfwm4 
- WM Theme: Dracula 
- Theme: Skeuos-Blue-Dark [GTK2/3] 
- Icons: Colloid-yellow-dark [GTK2/3] 
- Terminal: xfce4-terminal 
- Terminal Font: JetBrainsMono Nerd Font
I went for a blue theme.
# Installation
