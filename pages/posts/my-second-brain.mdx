...
Simply asking "why?" is a pretty generic question, so I'll aim to answer why *I* started using it, as well as why *you* should start using it, too. The main reason I started using Obsidian was for school. For my whole life, I had taken notes on plain ol' paper. This year, though, I wanted to try something different. I'll be entering higher education soon and I wanted to prepare myself for the workflow that comes with it. I also work well with rigid structure (think lists and steps for *everything*)... Besides, the difficulty of school this year kind of necessitated me being more organized.
