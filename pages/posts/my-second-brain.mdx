...
Simply asking "why?" is a pretty generic question, so I'll aim to answer why I started using it, as well as why *you* should start using it, too. The main reason I started using Obsidian was for school. For basically all of my academic life, I had taken notes on plain ol' paper. This year, though, I wanted to try something different, mainly because I'll be entering higher education soon, and I wanted to prepare myself for the workflow that comes with it. Also, I really like strict organization (lists and steps for *everything*, etc.), and the difficulty of school this year kind of necessitated me being more organized. Obsidian ended up being perfect for me.
